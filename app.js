...
//calling foursquare API
  function foursquareApi(data, callback){
        ...
        var URL = "https://api.foursquare.com/v2/venues/search?v=" + "&ll=" + LL + "&query=" + query + "&client_id=" + CLIENT_ID + "&client_secret=" + CLIENT_SECRET;
